...
messages={
    ...
    'essayTooLong':'Your {essay} response is too long. Please make certain that your character counts include spaces, and decrease the character count until the application goes through.',
...
emailMessages = {
    ...
    'recommenderRequestMail':'Dear {profName},\n{studentName} has requested that you recommend him or her to the AMGEN Scholars Summer Research Program affiliated with Columbia University, a 10-week, full-time research program. \
